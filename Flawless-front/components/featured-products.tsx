...
const featuredProducts = [
  ...
  },
  {
    ...
    title: 'MAQUILLAGE',
    description:
      'Les produits maquillage à avoir dans votre trousse de beauté pour un look parfait.',
  ...
  },
  {
    ...
    title: 'ALOE',
    description:
      "La meilleure gamme de soins capillaires à base d'Aloe Vera pour cheveux en bonne santé.",
    image: '/placeholder.svg?height=300&width=400',
    buttonText: 'Voir les produits',
    buttonColor: 'bg-pink-600 hover:bg-pink-700',
  },
