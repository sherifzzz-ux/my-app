        ...
        <div className="bg-gradient-to-r from-pink-100 to-orange-100 rounded-lg p-8 mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-1 lg:order-2 text-center lg:text-left">
              <div className="bg-black text-white px-4 py-2 inline-block rounded mb-4">{showcaseProducts[0].brand}</div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">{showcaseProducts[0].title}</h2>
              ...
              <div className="flex items-center justify-center lg:justify-start space-x-4 mb-6">
                <span className="text-2xl font-bold text-pink-600">{showcaseProducts[0].price}</span>
                <span className="text-lg text-gray-500 line-through">{showcaseProducts[0].originalPrice}</span>
              </div>
              <Button
