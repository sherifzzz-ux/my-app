...
export default async function ComplementsAlimentairesPage({ params }: SubcategoryPageProps) {
  ...
  const categoryData = {
    id: 'cheveux',
    name: 'Cheveux',
    description: 'Découvrez notre sélection de soins capillaires et produits pour cheveux',
    icon: '💇‍♀️',
    color: 'bg-purple-500',
...
export async function generateMetadata({ params }: SubcategoryPageProps) {
  ...
  return {
    ...
    keywords: [`${subcategoryData.name}`, 'cheveux', 'beauté', 'soins'],
    openGraph: {
