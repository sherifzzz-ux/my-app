...
export default async function SoinsVisagePage({ params }: SubcategoryPageProps) {
  ...
  const categoryData = {
    id: 'parapharmacie',
    name: 'Parapharmacie',
    description: 'Découvrez notre sélection de produits de parapharmacie et compléments alimentaires',
    icon: '💊',
    color: 'bg-green-500',
...
export async function generateMetadata({ params }: SubcategoryPageProps) {
  ...
  return {
    ...
    keywords: [`${subcategoryData.name}`, 'parapharmacie', 'santé', 'compléments'],
    openGraph: {
