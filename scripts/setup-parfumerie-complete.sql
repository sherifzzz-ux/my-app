-- Script complet pour créer la catégorie Parfumerie et ses sous-catégories
...
-- 2. Récupérer l'ID de la catégorie Parfumerie
WITH parfumerie_category AS (
    SELECT id FROM "Category" WHERE slug = 'parfumerie'
)

-- 3. Ajouter les sous-catégories de Parfumerie
