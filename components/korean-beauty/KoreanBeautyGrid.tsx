...
import { KoreanBeautyCard } from './KoreanBeautyCard'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select'
import { Badge } from '@/components/ui/badge'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { Grid, List, Filter, Search, X, Leaf, Shield } from 'lucide-react'
import { KoreanBeautyProduct, koreanBeautyCategories } from '@/lib/data/korean-beauty'

interface KoreanBeautyGridProps {
  products: KoreanBeautyProduct[]
  title?: string
  showFilters?: boolean
}

export function KoreanBeautyGrid({ products, title, showFilters = true }: KoreanBeautyGridProps) {
  ...
  const subcategories = useMemo(() => {
    ...
    const categoryData = koreanBeautyCategories.find(c => c.id === selectedCategory)
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered
  }, [products, searchTerm, selectedCategory, selectedSubcategory, selectedSkinType, selectedTexture, selectedCertification, selectedStep, priceRange, sortBy])
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            placeholder="Rechercher un produit K-Beauty..."
            value={searchTerm}
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-lg">Filtres K-Beauty</CardTitle>
      ...
      {filteredProducts.length === 0 ? (
          ...
          <CardContent className="pt-8 pb-8">
            <div className="text-center">
              <p className="text-muted-foreground mb-4">
                Aucun produit K-Beauty ne correspond à vos critères de recherche.
              </p>
        ...
        <div className={
          ...
          {filteredProducts.map((product) => (
            <KoreanBeautyCard key={product.id} product={product} viewMode={viewMode} />
          ))}
        </div>
      )}
    </div>
