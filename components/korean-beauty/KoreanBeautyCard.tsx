...
import { Star, Heart, ShoppingCart, Info, Leaf, Shield } from 'lucide-react'
import Image from 'next/image'
import Link from 'next/link'
import { KoreanBeautyProduct } from '@/lib/data/korean-beauty'

interface KoreanBeautyCardProps {
  product: KoreanBeautyProduct
  viewMode?: 'grid' | 'list'
}

export function KoreanBeautyCard({ product, viewMode = 'grid' }: KoreanBeautyCardProps) {
