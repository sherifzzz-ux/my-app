...
import { Star, Heart, ShoppingCart, Info, Shield, Pill } from 'lucide-react'
import Image from 'next/image'
import Link from 'next/link'
import { ParapharmacieProduct } from '@/lib/data/parapharmacie'

interface ParapharmacieCardProps {
  product: ParapharmacieProduct
  viewMode?: 'grid' | 'list'
}

export function ParapharmacieCard({ product, viewMode = 'grid' }: ParapharmacieCardProps) {
