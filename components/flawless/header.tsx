...
export function Header() {
  ...
  > = {
    ...
    'SOIN DU VISAGE': {
      href: '/soin-du-visage',
      subcategories: [
        { name: 'Protection solaire', href: '/category/soin-du-visage/subcategory/protection-solaire' },
        { name: 'Soins du visage par produit', href: '/category/soin-du-visage/subcategory/soins-par-produit' },
        { name: 'Soins ciblés', href: '/category/soin-du-visage/subcategory/soins-cibles' },
        { name: 'Baumes hydratants lèvres', href: '/category/soin-du-visage/subcategory/baumes-levres' },
        { name: 'Démaquillants & Nettoyants', href: '/category/soin-du-visage/subcategory/demaquillants-nettoyants' },
      ],
    },
    'CORPS & BAIN': {
      href: '/corps-bain',
      subcategories: [
        { name: 'Soins Corps', href: '/category/corps-bain/subcategory/soins-corps' },
        { name: 'Bain & Douche', href: '/category/corps-bain/subcategory/bain-douche' },
        { name: 'Épilation', href: '/category/corps-bain/subcategory/epilation' },
        { name: 'Hygiène intime', href: '/category/corps-bain/subcategory/hygiene-intime' },
        { name: 'Mains & Pieds', href: '/category/corps-bain/subcategory/mains-pieds' },
      ],
    },
    PARAPHARMACIE: {
      href: '/parapharmacie',
      subcategories: [
        { name: 'Complément Alimentaire', href: '/category/parapharmacie/subcategory/complements' },
        { name: 'Soins du visage', href: '/category/parapharmacie/subcategory/soins-visage' },
        { name: 'Soins du corps', href: '/category/parapharmacie/subcategory/soins-corps' },
      ],
    },
    CHEVEUX: {
      href: '/cheveux',
      subcategories: [
        { name: 'Compléments alimentaires', href: '/category/cheveux/subcategory/complements-alimentaires' },
        { name: 'Routine capillaire', href: '/category/cheveux/subcategory/routine-capillaire' },
        { name: 'Soins cheveux', href: '/category/cheveux/subcategory/soins-cheveux' },
      ],
    },
    PARFUMERIE: {
      href: '/parfumerie',
      subcategories: [
        { name: 'Parfumerie Femmes', href: '/category/parfumerie/subcategory/parfums-femme' },
        { name: 'Parfumerie Hommes', href: '/category/parfumerie/subcategory/parfums-homme' },
        { name: 'Eaux de toilette', href: '/category/parfumerie/subcategory/eaux-de-toilette' },
        { name: 'Coffrets parfums', href: '/category/parfumerie/subcategory/coffrets-parfums' },
      ],
    },
